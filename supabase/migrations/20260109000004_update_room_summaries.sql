-- Update room_summaries view to include hidden_at and filter out hidden rooms
-- Rooms are hidden when hidden_at is set AND the last message is older than hidden_at
-- (i.e., no new messages since hiding)
