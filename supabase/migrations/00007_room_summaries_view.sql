-- Add FK for PostgREST embedding from messages -> profiles
ALTER TABLE messages
    ADD CONSTRAINT messages_sender_profile_fkey
    FOREIGN KEY (sender_user_id) REFERENCES profiles(user_id) NOT VALID;

-- Room summaries view (per-user room list data)
